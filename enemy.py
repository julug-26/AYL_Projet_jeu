...
class ScorpioEnemy(RoomEnemy):
    def __init__(self, x, y, target_player=None, hp=45, speed=1.4, color=(205, 55, 55)):
        super().__init__(x, y, target_player=target_player, hp=hp, speed=speed, color=color)

        self.sheet_idle = _load("assets/Scorpio_idle.png")
        self.sheet_walk = _load("assets/Scorpio_walk.png")
        self.sheet_attack = _load("assets/Scorpio_attack.png")
        self.sheet_hurt = _load("assets/Scorpio_hurt.png")
        self.sheet_death = _load("assets/Scorpio_death.png")
